...
MOVES = {
    ...
    # Расширение: из детали в общий план. Самый «выдыхающий» ход набора,
    # под развязку и под финал главы.
    "reveal_out":   dict(w0=2860, w1=2000, x0=0.42, x1=0.50, y0=0.44, y1=0.50,
                         ease="out"),
