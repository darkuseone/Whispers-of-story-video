...
def pick_segments(story, marks, total, job=None, shots=None):
    """
    ...
    """
    # job и shots — для окон из спецификации (n_shorts > 2, shorts_extra,
    # prefer_clips): они идут одним куском, монтаж из долей только у
    # хука и развязки.
...
def cut_plan(shots, t0, t1, rng, words=None, prefer_clips=False, cutter=None):
    """
...
def main(job_path):
    ...
    wins = pick_segments(story, marks, total, job=job, shots=shots)
